...
//                     var selectModifica = "<select name='subfondoListModifica' id='subfondoListModifica' class='form-control'>";
//                     var select = "<select name='subfondoList' id='subfondoList' class='form-control'>";
//                     if(seleccion==0){
...
//                         var selectModifica = "<select name='nombreBeneficiarioModifica' id='nombreBeneficiarioModifica' class='form-control'>";
//                         var select = "<select name='nombreBeneficiario' id='nombreBeneficiario' class='form-control'>";
//                         if(seleccion==0){
...
//             var datos = jQuery.parseJSON(response);
//             var listado = jQuery.parseJSON(datos.solicitudList);
//             var select = "<select name='documento' id='documento' class='form-control'>";
...
//             var select = "<select name='tipoRecurso' id='tipoRecurso' class='form-control' onchange='subfondo(this.value, 0);'>";
//             var selectModifica = "<select name='tipoRecursoModifica' id='tipoRecursoModifica' onchange='subfondo(this.value, 0);' class='form-control'>";
...
//             var selectModifica = "<select name='tipoGastoModifica' id='tipoGastoModifica' class='form-control'>";
//             var select = "<select name='tipoGasto' id='tipoGasto' class='form-control'>";
...
//             var datos = jQuery.parseJSON(response);
//             var listado = jQuery.parseJSON(datos.solicitudList);
//             var selectModifica = "<select name='tipoBeneficiarioModifica' id='tipoBeneficiarioModifica' onchange='beneficiario(this.value, 0);' class='form-control'>";
//             var select = "<select name='tipoBeneficiario' id='tipoBeneficiario' class='form-control' onchange='beneficiario(this.value, 0);'>";
...
//                         var td2="<td align='center'><br>"+tipoFile[filesSolicitud[i]["idFileType"]-2]["tipo"]+"</td>";
