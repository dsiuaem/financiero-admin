        <div class="small-box bg-info" style="text-align: left;">
            <div class="inner">
                <div><p style="font-weight:bold"><h5 style="display: inline-block;">Nueva requisición de bienes / materiales</h5> </p></div>
            </div>
        </div>
    ...
    <form id="registroDatosArticuloForm" name="registroDatosArticuloForm" method="POST" enctype="multipart/form-data">
        <div class="row form-group">
            ...
            <div class="col-12 col-md-8">
                ...
                <br>
                <input  id="descripcionArticuloServicio" name="descripcionArticuloServicio" rows="1" placeholder="Descripcion artículo/servicio" class="form-control">           
            </div>
            <div class="col col-md-2"></div>
        </div>
        ...
        <div class="row form-group">
            ...
            <div class="col-12 col-md-8">
                ...
                <br>
                <input  id="descripcionCuenta" name="descripcionCuenta" rows="1" placeholder="Descripcion cuenta" class="form-control">
            </div>
            <div class="col col-md-2"></div>
        </div>
        ...
        <div class="row form-group">
            ...
            <div class="col-12 col-md-8">
                ...
                <br>
                <input  type="text" id="descripcionFamilia" name="descripcionFamilia" rows="1" placeholder="Descripcion familia" class="form-control">
            </div>
            <div class="col col-md-2"></div>
        </div>
        ...
        <div class="row form-group">
            ...
            <div class="col-12 col-md-4">
                ...
                <input  type="text" id="procedencias" name="procedencias" rows="1" placeholder="Procedencias (Nac/Extran)" class="form-control">
            </div>
            <div class="col col-md-2"></div>
        </div>
        ...
        <div class="row form-group">
            ...
            <div class="col-12 col-md-4">
                ...
                <input  type="text" id="codigoArticulo" name="codigoArticulo" rows="1" placeholder="Código UPC" class="form-control">
                <label for="selectSm" class=" form-control-label">Descripción SAT</label>
                <input  type="text" id="descripcionSAT" name="descripcionSAT" rows="1" placeholder="Descripción SAT" class="form-control">
                <label for="selectSm" class=" form-control-label">Descripción Requisición</label>
                <input  type="text" id="descripcionRequisicion" name="descripcionRequisicion" rows="1" placeholder="Descripción Requisición" class="form-control">
                <label for="selectSm" class=" form-control-label"> Código UPC</label>
                <input  type="text" id="codigoUPC_2" name="codigoUPC_2" rows="1" placeholder=" Código UPC" class="form-control">
                <label for="selectSm" class=" form-control-label"> Observaciones</label>
                <input  type="text" id="observaciones" name="observaciones" rows="1" placeholder=" Observaciones" class="form-control">
            ...
            <div class="col-12 col-md-4">
                ...
                <input  type="text" id="unidadMedida" name="unidadMedida" rows="1" placeholder="Unidad de medida" class="form-control">
                
                <div class="row form-group">
                    <div class="col-12 col-md-6">
                        <label for="selectSm" class=" form-control-label">Procedencia (Nac/Extran)</label>
                        <input  type="text" id="procedenciaNacExtran" name="procedenciaNacExtran" rows="1" placeholder="Procedencia (Nac/Extran)" class="form-control">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <input  type="text" id="activoMenor" name="activoMenor" rows="1" placeholder="Activo Menor(SI/NO)" class="form-control">
        ...
        <div class="row form-group">
            ...
            <div class="col-8 col-md-2">
                ...
                <input  type="text" id="cuentaContable" name="cuentaContable" rows="1" placeholder="Cuenta contable" class="form-control">
            ...
            <div class="col-8 col-md-2">
                ...
                <input  type="text" id="subcuentaContable" name="subcuentaContable" rows="1" placeholder="Subcuenta contable" class="form-control">
                <label for="selectSm" class=" form-control-label">Compra mínima</label>
                <input  type="text" id="compraMinima" name="compraMinima" rows="1" placeholder="Compra mínima" class="form-control">
            ...
            <div class="col-8 col-md-2">
                ...
                <input  type="number" id="precioPromedio" name="precioPromedio" rows="1" placeholder="$" class="form-control">
                <label for="selectSm" class=" form-control-label">Agente aduanal </label>
                <input  type="text" id="agenteAduanal" name="agenteAduanal" rows="1" placeholder="Si/No" class="form-control">
                
            </div>
            <div class="col-8 col-md-2">
                <label for="selectSm" class=" form-control-label">Indicador IVA</label>
                <input  type="text" id="indicadorIVA" name="indicadorIVA" rows="1" placeholder="Indicador IVA" class="form-control">
