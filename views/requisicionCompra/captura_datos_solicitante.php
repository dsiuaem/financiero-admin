...
<form id="registroDatosSolicitanteForm" name="registroDatosSolicitanteForm" method="POST" enctype="multipart/form-data">
	...
	<div class="row form-group">
		...
		<div class="col-12 col-md-8">
			...
			<textarea  id="observaciones_solicitante" name="observaciones_solicitante" rows="2" placeholder="Observaciones" class="form-control"></textarea>
		</div>
		<div class="col col-md-2"></div>
	</div>
	...
	<div class="row form-group">
		...
		<div class="col-12 col-md-8">
			...
			<select  name="selectDireccionSolicitante" id="selectDireccionSolicitante" class="form-control-sm form-control">
				<option value="">Selecciona una opción</option>
	...
	<div class="row form-group">
		...
		<div class="col-12 col-md-8">
			...
			<select  name="selectAutorizacionPresupuesto" id="selectAutorizacionPresupuesto" class="form-control-sm form-control">
				<option value="">Selecciona una opción</option>
				<option selected value="1">op1</option>
			</select>
		</div>
