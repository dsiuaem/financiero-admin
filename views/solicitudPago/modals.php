<div class="modal fade" id="modalArchivos" tabindex="-1" role="dialog" aria-labelledby="scrollmodalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" id="cuerpoModal">
                <div id="alertModal" style="display: none;" class="sufee-alert alert with-close alert-danger alert-dismissible fade show">
                    No se seleccióno uno o ambos archivos.
                    <button id="ocultar" type="button" class="close" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form id="modalSolicitudPagoForm" name="modalSolicitudPagoForm" method="POST" enctype="multipart/form-data">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="registraFactura" data-dismiss="modal">REGISTRAR FACTURA</button>
            </div>
        </div>
    </div>
</div>

<div class="modal fade" id="modalDetalles" tabindex="-1" role="dialog" aria-labelledby="scrollmodalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body" id="cuerpoModal">
                <div id="alertModalConceptos" style="display: none;" class="sufee-alert alert with-close alert-danger alert-dismissible fade show">
...
<div class="modal fade" id="modalXML" tabindex="-1" role="dialog" aria-labelledby="scrollmodalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" id="cuerpoModal">
                <div id="alertModalXML" style="display: none;" class="sufee-alert alert with-close alert-danger alert-dismissible fade show">
...
<div class="modal fade" id="modalPDF" tabindex="-1" role="dialog" aria-labelledby="scrollmodalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" id="cuerpoModal">
                <div id="alertModalPDF" style="display: none;" class="sufee-alert alert with-close alert-danger alert-dismissible fade show">
                    El campo no puede estar vacio.
                    <button id="ocultar" type="button" class="close" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
