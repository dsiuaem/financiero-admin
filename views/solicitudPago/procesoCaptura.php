...
<div class="row">
    ...
    <div class="col-lg-3">
        ...
        <button id="btnUpdateSolicitudPago" name="btnUpdateSolicitudPago" class="btn btn-primary">Finalizar Captura
        </button>
    </div>
</div>
<div class="card-body card-block">
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        <li class="nav-item">
            <a class="nav-link active" id="datosGenerales-tab" data-toggle="tab" href="#datosGenerales" role="tab"
               aria-controls="datosGenerales" aria-selected="true">Datos Generales</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" id="facturas-tab-tab" data-toggle="tab" href="#facturas" role="tab"
               aria-controls="facturas" aria-selected="false">Facturas</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" id="otrosArchivos-tab-tab" data-toggle="tab" href="#otrosArchivos" role="tab"
               aria-controls="otrosArchivos" aria-selected="false">Anexos</a>
        </li>
    </ul>
    <div class="tab-content pl-3 p-1" id="myTabContent">
        <div class="tab-pane fade show active" id="datosGenerales" role="tabpanel" aria-labelledby="datosGenerales-tab">
            <div class="col-lg-12">
                <form class="form-horizontal" id="modificaSolicitudPagoForm" name="modificaSolicitudPagoForm"
                      method="POST" enctype="multipart/form-data">
                    <div class="row form-group">
                        <div class="col col-md-12">
                            <input type="text" name="idSolicitud" id="idSolicitud" style="width: 100px;"
                                   class="form-control" hidden>
                            <label id="tipoTramiteModificaLabel" name="tipoTramiteModificaLabel" style="display: none">Solicitud
                                de Pago</label>
                            <input type="text" name="tipoTramiteModifica" id="tipoTramiteModifica"
                                   value="Solicitud de Pago" hidden>
                        </div>
                    </div>
                    <div class="row form-group">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9">
                            <input type="text" name="importeModifica" id="importeModifica" placeholder="IMPORTE"
                                   class="form-control">
                        </div>
                    </div>
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9">
                            <textarea name="conceptoModifica" id="conceptoModifica" placeholder="CONCEPTO"
        ...
        <div class="tab-pane fade" id="facturas" role="tabpanel" aria-labelledby="facturas-tab">
            <br>
            <button id="ocultarCerrar" type="button" class="btn btn-info btn-sm" data-toggle="modal"
                    data-target="#modalArchivos">AGREGAR FACTURA
            </button>
            <br><br>
            <div class="col-md-12">
                    ...
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col col-md-2">
                                <p align="right">
                                    <button type="button" class="btn btn-info btn-outline-secondary" data-toggle="modal"
                                            data-target="#modalDetalles">CONCEPTOS
                                    </button>
                                </p>
                            </div>
                        </div>
                                            ...
                                            <div class="col col-md-4">
                                                <p align="center">
                                                    <button type="button" class="btn btn-outline-primary"
                                                            data-toggle="modal" data-target="#modalXML">Agregar XML
                                                    </button>
                                                </p>
                                                <p align="center">
                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            ...
                                            <div class="col col-md-4">
                                                <p align="center">
                                                    <button type="button" class="btn btn-outline-primary"
                                                            data-toggle="modal" data-target="#modalPDF">Agregar PDF
                                                    </button>
                                                </p>
                                                <p align="center">
                                                    <button type="button" class="btn btn-danger">Eliminar</button>
