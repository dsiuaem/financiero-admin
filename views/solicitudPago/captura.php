...
<!-- 
				...
				<div class="row form-group">
					...
					<div class="col-12 col-md-8">
						...
						<label id="textoCuentaBancaria" for="listSubRecurso" style="display: none;" class="form-control-label">Cuenta Bancaria</label>
				...
				<div class="row form-group">
					<div class="col col-md-2"></div>	
					<div class="col-12 col-md-8">
						<label id="textoBeneficiario" for="listBeneficiarios" style="display: none;" class="form-control-label" >Nombre beneficiario</label>
