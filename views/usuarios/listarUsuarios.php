                        ...
                        <form id="listadoUsuarios" name="listadoUsuarios" method="POST" enctype="multipart/form-data">
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-8">
                                    ...
                                    <select name="systemNameListarUsuarios" id="systemNameListarUsuarios" class="form-control"></select>
                                </div>
                                <div class="col col-md-2"></div>
                            </div>
                        </form>
            ...
            <div class="modal-body mx-3">
                ...
                <form id="actualizacionUsuario" name="actualizacionUsuario" method="POST"
                    ...
                    <div class="row form-group">
                        <div class="col col-md-2"></div>
                        <div class="col-12 col-md-8">
                            <label class="form-control-label">Modificar contraseña:</label>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body mx-3">
                ...
                <div class="modal-footer">
                    <button type="button" style="" id="btn_cancel" name="btn_cancel" data-dismiss="modal" class="btn btn-danger">
                        <i class="fas fa-times-circle"></i> Cancelar
                    </button>
                </div>
            </div>
            ...
            <div class="modal-body mx-3">
                ...
                <form id="actualizacionPerfil" name="actualizacionPerfil" method="POST"
                    ...
                    <div class="row form-group">
                        <div class="col col-md-2"></div>
                        <div class="col-12 col-md-8">
                            <label class="form-control-label">Selecciona un perfil:</label>
                            <div class="listaEditarPerfiles"></div>
                        </div>
                        <div class="col col-md-2"></div>
                    </div>
